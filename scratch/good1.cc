...
/*
 * good1: receiver bottleneck / incast.
 *
 * Topology: 6 long-message senders, 1 probe sender, and 1 receiver
 * connected through one switch.  The long senders create a receiver-downlink
 * bottleneck; the probe sender measures short-message FCT under unloaded and
 * incast conditions.
 */
...
NS_LOG_COMPONENT_DEFINE ("Good1ReceiverBottleneck");
...
main (int argc, char* argv[])
{
  ...
  std::string outputDir = "outputs/sird-scenarios/good1";
